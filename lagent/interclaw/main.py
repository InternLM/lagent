...
from lagent.interclaw.app import InterclawApp
from lagent.interclaw.channels.cli import CLIChannel
from lagent.interclaw.channels.feishu import FeishuChannel
from lagent.interclaw.services.cron import CronService
from lagent.interclaw.services.heartbeat import HeartbeatService
...
def main():
    ...
    app.register_channel(FeishuChannel,
