...
3. Return output in English as a single list of all the entities and relationships identified in steps 1 and 2. Use **{item_delimiter}** as the list delimiter.
...
CONTINUE_PROMPT = ("MANY entities and relationships were missed in the last extraction. Remember to ONLY emit entities "
                   "that match any of the previously extracted types. Add them below using the same format:\n")
LOOP_PROMPT = ("It appears some entities and relationships may have still been missed.  Answer YES | NO if there are "
               "still entities or relationships that need to be added.\n")
